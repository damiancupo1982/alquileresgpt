...
const TenantsManager: React.FC<TenantsManagerProps> = ({ tenants, setTenants, properties, updatePropertyTenant }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const newTenant: Tenant = {
      ...
      contractUpdateEveryMonths: parseInt(formData.contractUpdateEveryMonths) || 0,
      contractUpdateType: formData.contractUpdateType as 'monto' | 'porcentaje',
      contractUpdateValue: parseFloat(formData.contractUpdateValue) || 0,
    ...
    setFormData({ 
      name: '', email: '', phone: '', propertyId: '', contractStart: '', contractEnd: '', contractUpdateEveryMonths: '6', contractUpdateType: 'porcentaje', contractUpdateValue: '', deposit: '',
  ...
  const handleEdit = (tenant: Tenant) => {
    ...
    setFormData({
      ...
      contractUpdateEveryMonths: tenant.contractUpdateEveryMonths?.toString() || '6',
      contractUpdateType: (tenant.contractUpdateType || 'porcentaje') as any,
      contractUpdateValue: tenant.contractUpdateValue?.toString() || '',
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <button
          onClick={() => {
            setFormData({ name: '', email: '', phone: '', propertyId: '', contractStart: '', contractEnd: '', contractUpdateEveryMonths: '6', contractUpdateType: 'porcentaje', contractUpdateValue: '', deposit: '', guarantorName: '', guarantorEmail: '', guarantorPhone: '' });
            setEditingTenant(null);
            setShowModal(true);
          }}
          ...
          <div className="bg-white rounded-xl p-6 w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Cada cuántos meses actualiza</label>
                  <input
                    type="number"
                    min={1}
                    value={formData.contractUpdateEveryMonths}
                    onChange={(e) => setFormData({ ...formData, contractUpdateEveryMonths: e.target.value })}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    required
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    value={formData.contractUpdateType}
                    onChange={(e) => setFormData({ ...formData, contractUpdateType: e.target.value })}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    required
                  >
                ...
                <div className="md:col-span-2">
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    Valor de actualización {formData.contractUpdateType === 'porcentaje' ? '(%)' : '($)'}
                  </label>
                  <input
                    type="number"
                    step="0.01"
                    value={formData.contractUpdateValue}
                    onChange={(e) => setFormData({ ...formData, contractUpdateValue: e.target.value })}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    required
                  />
                </div>
