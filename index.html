              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  >
                    <option value="Ramos Mejia">Departamento</option>
                    <option value="Limay">Galpón</option>
                    <option value="Bolivar">Local</option>
                    <option value="Faena">Oficina</option>
                    <option value="Alvear">Otro</option>
                    <option value="Gaboto">Oficina</option>
                    <option value="Gazcon">Otro</option>
                  </select>
                </div>
